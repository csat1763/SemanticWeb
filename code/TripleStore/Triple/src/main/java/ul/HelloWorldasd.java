 ...
 * </p>
 */
public class HelloWorldasd extends RecipeBase {
	/***********************************/
	/* Constants */
	/***********************************/
	...
	private static final Logger log = LoggerFactory.getLogger(HelloWorldasd.class);
	...
	public static void main(String[] args) {
		new HelloWorldasd().setArgs(args).run();
	}
